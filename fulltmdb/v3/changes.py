...
def movie(disable_cache=False, **kwargs):
    ...
    return _call('GET', 'https://api.themoviedb.org/3/movie/changes', disable_cache, params=kwargs)
...
def tv(disable_cache=False, **kwargs):
    ...
    return _call('GET', 'https://api.themoviedb.org/3/tv/changes', disable_cache, params=kwargs)
...
def person(disable_cache=False, **kwargs):
    ...
    return _call('GET', 'https://api.themoviedb.org/3/person/changes', disable_cache, params=kwargs)

...
class People():
    def get_details(person_id, **kwargs):
        '''
    ...
    def get_changes(person_id, **kwargs):
        '''
    ...
    def get_movie_credits(person_id, **kwargs):
        '''
    ...
    def get_combined_credits(person_id, **kwargs):
        '''
    ...
    def get_external_ids(person_id, **kwargs):
        '''
    ...
    def get_tagged_images(person_id, **kwargs):
        '''
    ...
    def get_translations(person_id, **kwargs):
        '''

...
def available_regions(disable_cache=False, **kwargs):
    ...
    return _call('GET', 'https://api.themoviedb.org/3/watch/providers/regions', disable_cache, params=kwargs)
...
def movie_providers(disable_cache=False, **kwargs):
    ...
    return _call('GET', 'https://api.themoviedb.org/3/watch/providers/movie', disable_cache, params=kwargs)
...
def tv_providers(disable_cache=False, **kwargs):
    ...
    return _call('GET', 'https://api.themoviedb.org/3/watch/providers/tv', disable_cache, params=kwargs)
